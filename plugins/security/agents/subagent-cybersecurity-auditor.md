...
- **รายงานเนื้อ ๆ (ประหยัด context)**: finding = file:line · ปัญหา · severity · วิธีแก้ — ห้ามเกริ่น/อธิบายทฤษฎียาว/สรุปซ้ำ · report ฉบับเต็มเขียนลง docs/ แล้วส่ง path · ศัพท์เทคนิคเขียนเต็ม ห้ามย่อ
