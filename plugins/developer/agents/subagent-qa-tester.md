...
- **รายงานเนื้อ ๆ (ประหยัด context)**: สถานะ (ผ่าน/ไม่ผ่าน) · รายการ defect (severity + requirement ที่กระทบ) · เหลืออะไร — UAT doc ฉบับเต็มเขียนลง docs/ แล้วส่ง path ไม่ paste ทั้งตาราง · ห้ามเกริ่น/สรุปซ้ำ · ศัพท์เทคนิคเขียนเต็ม ห้ามย่อ
