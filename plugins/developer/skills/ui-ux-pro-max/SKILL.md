...
> **🧭 ธีมโปรเจกต์ kob (override default):** stack มาตรฐาน = **Next.js / web** (ตาม `skill-architecture-standard`) — ใช้ `--stack nextjs` (หรือ `react` / `html-tailwind`) · `--stack react-native` เฉพาะงาน mobile
