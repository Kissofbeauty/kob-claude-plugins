...
- **Retention policy (BI เคาะเบื้องต้น · รอ legal ยืนยันขั้นสุดท้ายก่อน go-live):**
  - ปกติ (ลูกค้าไม่ได้ขอใช้สิทธิ์): soft-delete **1.5 ปี (18 เดือน)** → hard-delete
  - ขอใช้สิทธิ์ลบข้อมูล (PDPA ม.33): soft-delete **30 วัน** → hard-delete (อ้างประกาศหลักเกณฑ์การลบทำลายข้อมูลฯ)
  - ⚠️ **ยกเว้น legal-hold:** ข้อมูลที่กฎหมายอื่นบังคับให้เก็บ (บัญชี/ภาษี/ธุรกรรมการเงิน) — ห้ามลบตามกำหนดข้างบน · **หลัง go-live ก่อนลบจริงต้องให้ทีม BI ประเมินก่อน**
